...
# 1.6.2.3 쿨타임 텍스트 표기
# 1.6.2.4 쿨타임이 정상적으로 안도는 버그 픽스
# 1.6.2.5 사운드 구현, 게임오버후 재시작안되는 오류 수정
# 1.6.2.6 쿨타임 사용후 텍스트 표기
...
# 게임 초기화
def initGame():
    global gamePad, clock, background, fighter, missile, explosion, cooldown_font, s_shot, s_explode, s_destroy
    pygame.init()
    ...
    s_explode = pygame.mixer.Sound('sound/big.wav')
    s_destroy = pygame.mixer.Sound('sound/small.wav')
...
# 게임 루프 정의
def runGame():
    global gamepad, clock, background, fighter, missile, explosion, missile_interval, missile_direction, missile_group, bg_y1, bg_y2, cooldown_time
    ...
    while not onGame:
        ...
        for event in pygame.event.get():
            ...
            if event.type in [pygame.KEYDOWN]:
                ...
                elif event.key == pygame.K_v or event.key == pygame.K_V: # v키
