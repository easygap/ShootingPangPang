...
# 게임 루프 정의
def runGame():
    global gamepad, clock, background, fighter, missile, explosion, missile_interval, missile_group, bg_y1, bg_y2, cooldown_time, last_frame_time, auto_fire_time
    ...
    # 미사일 발사 간격 설정 (초 단위)
    missile_interval = 0
    auto_fire_interval = 1  # 자동 공격 간격 (초 단위)
    ...
    while not onGame:
        ...
        for event in pygame.event.get():
            ...
            if current_time - auto_fire_time > auto_fire_interval:  # 미사일 발사
                # missilesound.play()
